            ...
            <section className="mb-16">
              ...
              <div className="prose prose-lg md:prose-xl max-w-none prose-headings:font-display prose-headings:font-normal prose-p:font-body prose-p:text-ink-light prose-p:leading-relaxed">
                {blogContent ? (
                  ...
                  // Fallback to short story
                  <div className="first-letter:text-7xl first-letter:font-display first-letter:font-normal first-letter:text-terracotta-500 first-letter:float-left first-letter:mr-3 first-letter:leading-none first-letter:mt-1">
                    <p className="text-xl md:text-2xl text-ink-light leading-relaxed font-body whitespace-pre-line">
                      {recipe.story}
                    </p>
                  </div>
                )}
